            ...
            @foreach ($processingOrders as $order)
                <div wire:key="processing-{{ $order->id }}" class="flex-shrink-0 w-[500px] rounded-2xl shadow-md overflow-hidden border-4 border-yellow-400 bg-yellow-50">
                    ...
                    <div class="px-4 py-3 bg-gray-100 border-b">
                        ...
                        <div class="mt-2">
                            <button type="button"
                                    onclick="window.openOrderDetails('kitchen-processing-details-{{ $order->id }}')"
                    ...
                    <dialog wire:ignore.self id="kitchen-processing-details-{{ $order->id }}" class="w-[calc(100%-1.5rem)] sm:w-full max-w-2xl rounded-2xl p-0 backdrop:bg-black/50">
